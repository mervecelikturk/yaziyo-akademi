...
(function (global) {
    ...
    function buildHeaderInner(active) {
        ...
        <div class="yaziyo-header-bar max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-1.5 flex items-center justify-between gap-2">
            <a href="index.html" class="yaziyo-header-logo flex items-center gap-2 group shrink-0 min-w-0" id="logo-link">
                <img src="../images/logo.png" alt="YAZİYO Logo"
        ...
        <nav id="main-navbar" class="bg-light-bg/80 dark:bg-dark-bg/80 backdrop-blur-md transition-colors duration-300">
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <ul id="desktop-menu" class="hidden lg:flex items-center justify-center gap-x-0.5 xl:gap-x-1 py-2 text-[9px] xl:text-[10px] 2xl:text-[11px] font-medium flex-nowrap">
                    <li><a href="index.html" class="nav-link${ac(active, 'anasayfa')}" data-page="anasayfa">Ana Sayfa</a></li>
                    <li><a href="profil.html" class="nav-link${ac(active, 'profil')}" data-page="profil">Profil</a></li>
                    <li class="nav-dropdown">
                        ...
                        <ul class="nav-dropdown-menu">
                            <li><a href="hizTesti.html" class="nav-dropdown-item">Hız Testi</a></li>
                            <li><a href="klavyeCalismasi.html" class="nav-dropdown-item">Klavye Çalışması</a></li>
                            <li><a href="ozelMetinCalismasi.html" class="nav-dropdown-item">Özel Metin Çalışması</a></li>
                    ...
                    <li class="nav-dropdown">
                        ...
                        <ul class="nav-dropdown-menu">
                            ...
                            <li><a href="kelimeEvi.html" class="nav-dropdown-item">Kelime Evi</a></li>
                            <li><a href="arabaYarisi.html" class="nav-dropdown-item">Araba Yarışı</a></li>
                        </ul>
                    </li>
                    <li class="nav-dropdown">
                    ...
                    <li><a href="kpssCalismasi.html" class="nav-link${ac(active, 'kpss-calismasi')}" data-page="kpss-calismasi">KPSS Çalışması</a></li>
                    <li><a href="iletisim.html" class="nav-link${ac(active, 'iletisim')}" data-page="iletisim">İletişim</a></li>
                </ul>
                ...
                <div id="mobile-menu" class="lg:hidden hidden overflow-hidden transition-all duration-300">
                    <ul class="flex flex-col gap-1 pb-4 text-sm">
                        <li><a href="index.html" class="mobile-nav-link${ac(active, 'anasayfa')}" data-page="anasayfa">Ana Sayfa</a></li>
                        <li><a href="profil.html" class="mobile-nav-link${ac(active, 'profil')}" data-page="profil">Profil</a></li>
                        <li class="mobile-dropdown${mobOpen(active, 'klavye-calismalari')}">
                            ...
                            <ul class="mobile-dropdown-menu${mobOpen(active, 'klavye-calismalari')} flex flex-col gap-1 pl-3 pt-1">
                                <li><a href="hizTesti.html" class="mobile-nav-link text-[0.8em]">Hız Testi</a></li>
                                <li><a href="klavyeCalismasi.html" class="mobile-nav-link text-[0.8em]">Klavye Çalışması</a></li>
                                <li><a href="ozelMetinCalismasi.html" class="mobile-nav-link text-[0.8em]">Özel Metin Çalışması</a></li>
                        ...
                        <li class="mobile-dropdown${mobOpen(active, 'oyunlar')}">
                            ...
                            <ul class="mobile-dropdown-menu${mobOpen(active, 'oyunlar')} flex flex-col gap-1 pl-3 pt-1">
                                ...
                                <li><a href="kelimeEvi.html" class="mobile-nav-link text-[0.8em]">Kelime Evi</a></li>
                                <li><a href="arabaYarisi.html" class="mobile-nav-link text-[0.8em]">Araba Yarışı</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a href="kpssCalismasi.html" class="mobile-nav-link${ac(active, 'kpss-calismasi')}" data-page="kpss-calismasi">KPSS Çalışması</a></li>
                        <li><a href="iletisim.html" class="mobile-nav-link${ac(active, 'iletisim')}" data-page="iletisim">İletişim</a></li>
                    </ul>
                </div>
            </div>
        </nav>`;
